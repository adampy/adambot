...
class Starboard(commands.Cog):
    ...
    # --- Starboard embed ---
    async def make_starboard_embed(self, message: discord.Message, stars: int, emoji, color: discord.Color) -> discord.Embed:
        """
    ...
    async def _get_starboards(self, guild_id: int):
        """
    ...
    async def _try_get_starboard(self, channel_id: int):
        """
    ...
    async def _create_starboard(self, channel: discord.TextChannel, is_custom_emoji: bool, emoji: Union[discord.Emoji, str], minimum_stars: int, embed_colour: str = None, allow_self_star: bool = True):
        """
    ...
    async def _delete_starboard(self, channel: discord.TextChannel):
        """
    ...
    async def _try_get_starboard_entry(self, starboard_channel_id: int, message_id: int):
        """
    ...
    async def _create_starboard_entry(self, starboard_channel_id: int, message_id: int, bot_message_id: int):
        """
    ...
    async def _delete_starboard_entry(self, starboard_channel_id: int, message_id: int):
        """
    ...
    async def _update_starboard(self, starboard_channel_id: int, starboard_data: dict):
        """
    ...
    async def _is_valid_emoji(self, emoji: str, msg_context: commands.Context) -> list[bool, Union[discord.Emoji, str, bool]]:
        """
    ...
    def _is_valid_hex_colour(self, string: str) -> Union[int, bool]:
        """
    ...
    def _get_emoji_from_starboard_data(self, starboard):
        """
    ...
    async def on_raw_reaction_event(self, payload):
    ...
    # --- Error handlers ---
    @edit.error
    async def starboard_edit_error(self, ctx, error):
        """
 ...
 `option` must be one of 'minimum', 'emoji', 'colour'/'color'/'embed_colour', or 'self_star'\n`value` is the value that you want to change it do""")
    ...
    @delete.error
    async def starboard_delete_error(self, ctx, error):
        """
